...
+--------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Recommended Citation** | Omondi, A. (2023). *BBT4206-R-Lab2c-of15-SentimentAnalysis* (Version 1) [R]. <https://github.com/course-files/BBT4206-R-Lab2c-of15-SentimentAnalysis> (Original work published 2023) |
|                          |                                                                                                                                                                                      |
|                          | BibTex: [RecommendedCitation.bib](RecommendedCitation.bib)                                                                                                                           |
+--------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
